# WordNest 0.3.2 — luyện đến khi đúng tất cả

Đây là bản phát hành thay cho lần thử 0.3.1 chưa công bố bộ cài: đã cập nhật kiểm thử Windows theo thao tác chọn đáp án một lần. Không bỏ kiểm tra chức năng; bộ cài phải vượt qua toàn bộ quy trình trước khi được công bố.
...
Chế độ **Kiểm tra** vẫn là bài thi: được chuyển câu và nộp bài để xem điểm, không áp dụng vòng luyện lại. Bản sao lưu chứa lượt luyện mới cần WordNest 0.3.2 trở lên để khôi phục.

## Tải và cập nhật app

- Windows 10/11 x64: `WordNest-Setup-0.3.2-x64.exe`.
- Mac Apple Silicon (M1/M2/M3/M4…): `WordNest-0.3.2-arm64.dmg`.
- Mac Intel: `WordNest-0.3.2-x64.dmg`.
