# WordNest 0.3.3 — luyện đến khi đúng tất cả
...
Chế độ **Kiểm tra** vẫn là bài thi: được chuyển câu và nộp bài để xem điểm, không áp dụng vòng luyện lại. Bản sao lưu chứa lượt luyện mới cần WordNest 0.3.3 trở lên để khôi phục.

## Tải và cập nhật app

- Windows 10/11 x64: `WordNest-Setup-0.3.3-x64.exe`.
- Mac Apple Silicon (M1/M2/M3/M4…): `WordNest-0.3.3-arm64.dmg`.
- Mac Intel: `WordNest-0.3.3-x64.dmg`.
